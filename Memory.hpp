...
class Memory
{
  public:
    ...
    // TODO (Handle NES memory mappers): Move addressing modes out of CPU to this Memory class to handle memory translations (https://wiki.nesdev.com/w/index.php/Mapper)
    //
    // // Addressing modes
